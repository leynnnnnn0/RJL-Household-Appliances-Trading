...
export default function Edit({ backUrl, customer, employees }: EditProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        is_employment_verified:
            customer.investigation_detail?.is_employment_verified || false,
        investigation_notes:
    ...
    const handleDeleteDocument = (documentId: number) => {
        router.delete(`/customers/${customer.id}/documents/${documentId}`, {
            onSuccess: () => {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Investigation and verification information
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Upload or manage supporting documents
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex w-full gap-2 sm:w-auto">
                                                            <Button
                                                                ...
                                                                variant="outline"
                                                                asChild
                                                                className="min-h-11 flex-1 sm:h-9 sm:min-h-0 sm:flex-none"
                                                            >
                                                                <a
                                                            ...
                                                            <Button
                                                                ...
                                                                className="min-h-11 flex-1 text-red-600 hover:text-red-700 sm:h-9 sm:min-h-0 sm:flex-none"
                                                            >
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="rounded-lg border-2 border-dashed p-4 text-center transition-colors hover:border-primary sm:p-6">
                                    <input
                                        type="file"
                                        id="fileUpload"
                                        className="hidden"
