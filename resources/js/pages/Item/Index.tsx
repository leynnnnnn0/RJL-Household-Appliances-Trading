...
import { ItemWithRelations, Location, Paginated, Supplier } from '@/types';
...
export default function Index({ items, suppliers, locations }: PageProps) {
    ...
    const handleMoveSubmit = (e: React.FormEvent) => {
        ...
        moveForm.put(`/items/${selectedItem.id}/move`, {
            ...
            onError: (e) => {
                toast.error(
                    'Failed to move item. Please check the form for errors.',
                );
            },
        });
    };
                                ...
                                items.data.map((item) => (
                                    ...
                                    >
                                        ...
                                        <TableCell className="font-mono text-sm">
                                            {formatItemCurrency(item.unit_cost)}
                                        </TableCell>
            ...
            <Dialog open={moveDialogOpen} onOpenChange={setMoveDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Select a new location and add remarks for moving
                            this item.
                        </DialogDescription>
                    </DialogHeader>
