...
import { Search, Eye, Calendar, MapPin, User, Download, Filter, X } from "lucide-react";
...
export default function Index({ transactions, locations, employees }: Props) {
  ...
  useEffect(() => {
    const debounce = setTimeout(() => {
      ...
      router.get("/pos-cash-orders", params, { preserveState: true, replace: true });
    }, 400);
              ...
              {transactions.data.length === 0 ? (
                ...
                transactions.data.map((transaction) => (
                  <TableRow key={transaction.order_number} className="hover:bg-muted/50 transition-colors">
                    ...
                    <TableCell>
                      <Badge variant={transaction.is_void ? "destructive" : "default"}>
                    ...
                    {canViewDetails && (
                      <TableCell className="text-center">
                        <Button
                          ...
                          size="icon"
                          className="h-8 w-8"
                          onClick={() => router.visit(`/pos-cash-orders/${transaction.order_number}`)}
                        >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-base">Order #{transaction.order_number}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{transaction.employee.full_name}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{formatCurrency(transaction.total_price)}</p>
                      </div>
                    </div>
