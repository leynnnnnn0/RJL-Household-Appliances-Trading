...
export default function Edit({ role, permissions }: Props) {
    ...
    return (
        <AppLayout>
            ...
            <ModuleHeading title="Edit Role" description={`Update role: ${role.name}`}>
                                        ...
                                        <CardHeader className="border-b border-gray-300">
                                            <div className="flex items-center gap-3">
                                                <Checkbox
                                                    ...
                                                    className="border-black data-[state=checked]:bg-black data-[state=checked]:border-black w-5 h-5"
                                                />
                                                <Label
                                                ...
                                                {modulePermissions.map((permission) => (
                                                    ...
                                                    >
                                                        <Checkbox
                                                            ...
                                                            className="border-gray-400 data-[state=checked]:bg-black data-[state=checked]:border-black mt-0.5"
                                                        />
                                                        <Label
                                                            htmlFor={`permission-${permission.id}`}
                                                            className="text-sm leading-relaxed cursor-pointer group-hover:text-black font-medium"
                                                        >
                                                            {permission.name}
                                                        </Label>
                                                    </div>
