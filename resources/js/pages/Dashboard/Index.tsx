...
const inventoryData = [
  { category: 'Furniture', srp: 125000, unitCost: 85000 },
  { category: 'Gadgets', srp: 98000, unitCost: 62000 },
  { category: 'Appliances', srp: 156000, unitCost: 105000 },
];
                ...
                <div className="space-y-8 p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <Card className="border-l-4 border-l-gray-500 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <CardContent>
                                <div className="text-3xl font-bold">₱379,000</div>
                        ...
                        <Card className="border-l-4 border-l-gray-500 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <CardContent>
                                <div className="text-3xl font-bold">₱252,000</div>
                        ...
                        <Card className="border-l-4 border-l-gray-500 shadow-lg hover:shadow-xl transition-shadow">
                            ...
                            <CardContent>
                                ...
                                <p className="text-xs text-slate-500 mt-1">₱127,000 potential profit</p>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 border-blue-200">
                            ...
                            <CardContent>
                                <div className="text-4xl font-bold text-blue-900 dark:text-blue-100">1,284</div>
                        ...
                        <Card className="shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-950 dark:to-violet-900 border-violet-200">
                            ...
                            <CardContent>
                                <div className="text-4xl font-bold text-violet-900 dark:text-violet-100">38</div>
                        ...
                        <Card className="shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950 dark:to-emerald-900 border-emerald-200">
                            ...
                            <CardContent>
                                <div className="text-4xl font-bold text-emerald-900 dark:text-emerald-100">42</div>
