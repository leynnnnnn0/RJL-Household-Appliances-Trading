...
export default function Index({
    ...
    const receivablesData = [
        ...
        {
            name: '90+ Days',
            amount: receivables['90_plus_days'],
            fill: '#7f1d1d',
        },
    ];
    ...
    const accountStatusData = [
        ...
        {
            name: 'Completed',
            value: summary.completed_accounts,
            fill: '#10b981',
        },
        {
            name: 'Defaulted',
            value: summary.defaulted_accounts,
            fill: '#ef4444',
        },
    ];
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="mt-1 text-muted-foreground">
                        Comprehensive overview of installment order sales and
                        collections
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Filter sales data by date range, item type, and
                            location
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                Defaulted: {summary.defaulted_accounts} |
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {formatCurrency(summary.total_pnv)}
                            </div>
                            <p className="mt-1 text-xs text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-1 text-xs text-muted-foreground">
                                {collection_performance.collection_rate}%
                                collection rate
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-green-600">
                                {formatCurrency(summary.collectible_balance)}
                            </div>
                            <p className="mt-1 text-xs text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-red-600">
                                {formatCurrency(summary.defaulted_balance)}
                            </div>
                            <p className="mt-1 text-xs text-muted-foreground">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {formatCurrency(summary.total_lcp)}
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                       ...
                       <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {formatCurrency(summary.total_advanced_payment)}
                            </div>
                        </CardContent>
                    </Card>
                ...
                {/* Collection Performance & Revenue Breakdown */}
                <Card>
                    <CardHeader>
                        <CardTitle>
                            Collection Performance & Revenue Breakdown
                        ...
                        <CardDescription>
                            Track collection efficiency and additional revenue
                            streams
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="space-y-1 text-right">
                                        ...
                                        <p className="text-3xl font-bold text-muted-foreground">
                                            {collection_performance.target_rate}
                                            %
                                        </p>
                                    </div>
                                    <div className="space-y-1 text-right">
                                        ...
                                        <div className="flex items-center gap-2">
                                            {collection_performance.variance >=
                                            0 ? (
                                            ...
                                            <p
                                                className={`text-3xl font-bold ${collection_performance.variance >= 0 ? 'text-green-600' : 'text-red-600'}`}
                                            >
                                                {Math.abs(
                                                    collection_performance.variance,
                                                )}
                                ...
                                <div className="h-3 w-full rounded-full bg-secondary">
                                    <div
                                        ...
                                        style={{
                                            width: `${Math.min(collection_performance.collection_rate, 100)}%`,
                                        }}
                                    />
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="rounded-lg border bg-blue-50 p-4">
                                        ...
                                        <p className="text-2xl font-bold text-blue-700">
                                            {formatCurrency(
                                                summary.total_advanced_payment,
                                            )}
                                        </p>
                                    </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Outstanding balances by age category
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Payments received by age category
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Distribution of accounts and amounts
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={300}>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Distribution of active, completed, and defaulted
                                accounts
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Detailed analysis per item category
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-purple-600">
                                                {formatCurrency(
                                                    rebate_by_item_type[
                                                        item.name.toLowerCase() as keyof typeof rebate_by_item_type
                                                    ],
                                                )}
                                            </p>
                                        </div>
